...
long long unsigned int positive_fibonacci_recursive_memoizing(size_t n, long long unsigned int *memoize_array, size_t memoize_array_len) {
    if (n <= 1) return n;
    ...
    long long unsigned int result =
        positive_fibonacci_recursive_memoizing(n - 1, memoize_array, memoize_array_len) +
